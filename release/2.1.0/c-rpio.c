...
// serial_write
// SUMMARY: Write data to a device
// INPUTS:
//     fd   - The file descriptor of the stream
//     data - The reference to the data to write
...
{
	// Write data
    tcflush(fd, TCIOFLUSH);     		// Clear input and output buffers
...
// serial_available
// SUMMARY: Poll a device for data availability (blocking behavior)
// INPUTS:
//     fd      - The file descriptor of the stream
//     timeout - Timeout for the poll in milliseconds. (-1 is no timeout)
// OUTPUTS:
//      0 - No new data is available
//      1 - New data is available
int serial_available(int fd, int timeout)
{
	// Poll the fd
...
// serial_read
// SUMMARY: Read from a device (non-blocking behavior)
// INPUTS:
//     fd   - The file descriptor of the stream
//     buf  - Reference to the buffer to store data into
